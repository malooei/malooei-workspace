...
def PrepareBuilding(env, root_directory, has_libcpu=False, remove_components = []):
    ...
    objs.extend(SConscript(Rtt_Root + '/apps/SConscript', variant_dir='build/apps', duplicate=0))
    objs.extend(SConscript(Rtt_Root + '/apps/w25x16/SConscript', variant_dir='build/apps/w25x16', duplicate=0))
    objs.extend(SConscript(Rtt_Root + '/apps/tsc2046/SConscript', variant_dir='build/apps/tsc2046', duplicate=0))
    objs.extend(SConscript(Rtt_Root + '/apps/sram/SConscript', variant_dir='build/apps/sram', duplicate=0))
    objs.extend(SConscript(Rtt_Root + '/apps/insidefunction/SConscript', variant_dir='build/apps/insidefunction', duplicate=0))
    objs.extend(SConscript(Rtt_Root + '/apps/am2301/SConscript', variant_dir='build/apps/am2301', duplicate=0))
    objs.extend(SConscript(Rtt_Root + '/apps/enc28j60/SConscript', variant_dir='build/apps/enc28j60', duplicate=0))
    objs.extend(SConscript(Rtt_Root + '/apps/ssd1289/SConscript', variant_dir='build/apps/ssd1289', duplicate=0))
